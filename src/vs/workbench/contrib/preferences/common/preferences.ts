...
export const KEYBINDINGS_EDITOR_COMMAND_DEFINE_MOUSE = 'keybindings.editor.defineMouseBinding';
export const KEYBINDINGS_EDITOR_COMMAND_DEFINE_SELECTION = 'keybindings.editor.defineSelectionBinding';
